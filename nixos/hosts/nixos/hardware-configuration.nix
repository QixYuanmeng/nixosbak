...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/cc8a3466-7d13-419f-9593-0818725a02ea";
      fsType = "btrfs";
  ...
  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/B759-5434";
      fsType = "vfat";
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/df1136f2-b4d0-4bd1-91b8-e6eebefafe5e"; }
    ];
